...
if st.sidebar.button('Regression'):
    ...
    st.markdown('Plots')
    st.image('https://raw.githubusercontent.com/llorenc-fer/Allianz/blob/main/Graphs/output.png')
    st.image('https://raw.githubusercontent.com/llorenc-fer/Allianz/blob/main/Graphs/Ridge.png')
    ...
    st.image('https://raw.githubusercontent.com/llorenc-fer/Allianz/blob/main/Graphs/MLPRegressor.png')
